...
const NFTList = [
  {
    Name: "#DAOPIONEER",
    Image: require("assets/images/nftshop/DAOPIONEER.png"),
    Link: {
      internal : "/nfts",
  ...
  {
    Name: "#TFTMOTO",
    Image: require("assets/images/nftshop/TFTMOTO.png"),
    Link: {
      internal : "/nfts",
  ...
  {
    Name: "#TFTAIR1",
    Image: require("assets/images/nftshop/TFTAIR1.png"),
    Link: {
      internal : "/nfts",
  ...
  {
    Name: "#TFTOON1",
    Image: require("assets/images/nftshop/TFTOON1.png"),
    Link: {
      internal : "/nfts",
  ...
  {
    Name: "#TFTOON2",
    Image: require("assets/images/nftshop/TFTOON2.png"),
    Link: {
      internal : "/nfts",
  ...
  {
    Name: "#TFTMETAL1",
    Image: require("assets/images/nftshop/TFTMETAL1.png"),
    Link: {
      internal : "/nfts",
  ...
  {
    Name: "#TFTMETAL2",
    Image: require("assets/images/nftshop/TFTMETAL2.png"),
    Link: {
      internal : "/nfts",
  ...
  {
    Name: "#TFTMIDAS1",
    Image: require("assets/images/nftshop/TFTMIDAS1.png"),
    Link: {
      internal : "/nfts",
  ...
  {
    Name: "#TFTMIDAS2",
    Image: require("assets/images/nftshop/TFTMIDAS2.png"),
    Link: {
      internal : "/nfts",
