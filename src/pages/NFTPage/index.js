...
import background from "assets/images/nft/background.png";
import { ReactComponent as IconPurchase } from "assets/images/symbol/purchase.svg";
// import { ReactComponent as IconSoonaverse } from "assets/images/soonaverse.svg";
// import { ReactComponent as IconOpenSea } from "assets/images/opensea.svg";
  ...
  return (
    <>
      ...
      <Container>
        ...
        >
          <TFTSearchBox sx={{ marginTop: "2rem" }} />
        </TFTPageFace>
        <Grid container my={2}>
          {
            nft.list.map((n, i) => (
